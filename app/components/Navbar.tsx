...
const Navbar = ({color, contact, mobileColor, imageUrl, service, business, about}: any) => {
  ...
  return (
    <nav className='relative flex justify-between md:item-start items-center w-full py-4 px-6 md:py-6 md:px-24'>
        <div>
            <Image className='cursor-pointer' src={imageUrl} alt='logo' width={150} height={150}/>
        ...
        <button className="block lg:hidden flex-col flex gap-[.3rem]" onClick={toggleNav}>
          ...
          {showNav ? (
             ...
             <ul style={{color: color}} className='flex flex-col justify-between items-center gap-[2rem]'>
                 ...
                 <li className='text-white' style={active === 'services' ? {borderBottom: "3px solid #ED9E1F"} : {}} onClick={() => setActive('services')}><a href={service} className='no-underline'>Our Services</a></li>
        ...
        <div className='items-center justify-center hidden lg:flex' >
            <ul style={{color: color}} className='flex justify-between items-center gap-[2rem]'>
                ...
                <li style={active === 'services' ? {borderBottom: "3px solid #ED9E1F"} : {}} onClick={() => setActive('services')}><a href={service} className='no-underline'>Our Services</a></li>
