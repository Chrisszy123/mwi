...
const About = () => {
  return (
    <div className="w-full py-1 px-1 md:py-6 md:px-24 flex flex-col justify-center items-center mt-[3rem] gap-[1rem]">
      ...
      <span className="w-[90%] flex flex-col gap-[1rem] justify-center items-center tracking-[1px] text-[16px] md:text-center">
